...
void desktop_settings_scene_pin_setup_done_on_enter(void* context) {
    ...
    desktop_view_pin_input_set_label_button(app->pin_input_view, "Готово");
    desktop_view_pin_input_set_label_primary(app->pin_input_view, 29, 8, "PIN включен!");
    desktop_view_pin_input_set_label_secondary(
        app->pin_input_view, 7, 45, "Запомните или запишите");
