...
static void
    ...
    canvas_draw_str(canvas, 0, ROW_0_Y + 15, "Время");
...
static void
    ...
    canvas_set_font(canvas, FontPrimary);
    canvas_draw_str(canvas, 0, ROW_1_Y + 9, "Дата");
    // Day
...
static void
    ...
    canvas_set_font(canvas, FontPrimary);
    canvas_draw_str(canvas, 0, ROW_2_Y + 9, "Будильник");
