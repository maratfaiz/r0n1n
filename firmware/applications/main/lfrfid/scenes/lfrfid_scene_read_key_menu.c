...
void lfrfid_scene_read_key_menu_on_enter(void* context) {
    ...
    submenu_add_item(
        submenu, "Сохранить", SubmenuIndexSave, lfrfid_scene_read_key_menu_submenu_callback, app);
    submenu_add_item(
        submenu, "Эмуляция", SubmenuIndexEmulate, lfrfid_scene_read_key_menu_submenu_callback, app);
    submenu_add_item(
        submenu, "Записать", SubmenuIndexWrite, lfrfid_scene_read_key_menu_submenu_callback, app);
