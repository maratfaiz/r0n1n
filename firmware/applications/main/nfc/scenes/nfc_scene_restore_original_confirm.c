...
void nfc_scene_restore_original_confirm_on_enter(void* context) {
    ...
    dialog_ex_set_header(dialog_ex, "Восстановить данные?", 64, 0, AlignCenter, AlignTop);
    dialog_ex_set_icon(dialog_ex, 5, 11, &I_ArrowC_1_36x36);
    dialog_ex_set_text(
        dialog_ex, "Она вернется\nв исходное\nсостояние.", 47, 21, AlignLeft, AlignTop);
    dialog_ex_set_left_button_text(dialog_ex, "Отмена");
    dialog_ex_set_right_button_text(dialog_ex, "Восстановить");
