...
static void gpio_test_draw_callback(Canvas* canvas, void* _model) {
    ...
    elements_multiline_text_aligned(canvas, 64, 2, AlignCenter, AlignTop, "Тест выходов GPIO");
    canvas_set_font(canvas, FontSecondary);
    elements_multiline_text_aligned(canvas, 64, 16, AlignCenter, AlignTop, "< или > меняют пин");
