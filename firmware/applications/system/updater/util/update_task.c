...
// Shown on the R0N1N updater screen (FontSecondary, Cyrillic)
static const char* update_task_stage_descr[] = {
    [UpdateTaskStageProgress] = "...",
    [UpdateTaskStageReadManifest] = "Чтение манифеста",
    [UpdateTaskStageValidateDFUImage] = "Проверка DFU-файла",
    [UpdateTaskStageFlashWrite] = "Запись прошивки",
    [UpdateTaskStageFlashValidate] = "Проверка прошивки",
    [UpdateTaskStageRadioImageValidate] = "Проверка радиостека",
    [UpdateTaskStageRadioErase] = "Удаление радиостека",
    [UpdateTaskStageRadioWrite] = "Запись радиостека",
    [UpdateTaskStageRadioInstall] = "Установка радиостека",
    [UpdateTaskStageRadioBusy] = "Ядро 2 занято",
    [UpdateTaskStageOBValidation] = "Проверка опц. байтов",
    [UpdateTaskStageIntBackup] = "Резервная копия настроек",
    [UpdateTaskStageIntRestore] = "Восстановление настроек",
    [UpdateTaskStageResourcesFileCleanup] = "Очистка файлов",
    [UpdateTaskStageResourcesDirCleanup] = "Очистка папок",
    [UpdateTaskStageResourcesFileUnpack] = "Распаковка ресурсов",
    [UpdateTaskStageSplashscreenInstall] = "Установка заставки",
    [UpdateTaskStageCompleted] = "Перезагрузка...",
    [UpdateTaskStageError] = "Ошибка",
